...
Report findings as structured JSON matching the provided schema.
...
Inspect the actual repository and the session diff yourself. The coder's summary below may be incomplete or inaccurate.`
    : `## Session diff summary
...
/** JSON schema for the reviewer structured output, in SDK OutputFormat shape. */
